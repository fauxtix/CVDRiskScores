...
namespace CVDRiskScores.Services.Framingham
{
    ...
    {
        public int GetAgePoints(int age, Genero gender)
        {
            int points;
        ...
        public int GetSmokingPoints(Genero gender, bool isSmoker, int age)
        {
            return gender switch
            {
                Genero.Male => CalculatePointsForMaleSmoking(isSmoker, age),
                Genero.Female => CalculatePointsForFemaleSmoking(isSmoker, age),
                _ => 0,
            };
        }
        ...
        */
        ...
        public int GetTotalCholesterolPoints(int age, Genero gender, int totalCholesterol)
        {
            int points;
        ...
        public int GetHDLCholesterolPoints(Genero gender, int hdlCholesterol)
        {
            return gender switch
            {
                Genero.Male => CalculatePointsForMaleHDLCholesterol(hdlCholesterol),
                Genero.Female => CalculatePointsForFemaleHDLCholesterol(hdlCholesterol),
                _ => 0,
            };
        }
        ...
        public int GetSystolicBloodPressurePoints(int systolicBloodPressure, bool isTreated, Genero gender)
        {
            int points;
